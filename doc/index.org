...
Org markup inside Common Lisp docstrings.  The reference is rendered
into [[file:api/index.org][doc/api/index.org]] — one page per package plus a symbol index.
...
| Pure actor manifest registry | Active | Validates StarLang portable manifests and provides deterministic, topology-safe discovery; HTTP/runtime integration is deferred |
