...
D.update({
 ...
 'operation-fbp-node-object': 'Project one canonical HTTP operation into a typed FBP component descriptor.',
 'fbp-node-catalog-document': 'Typed FBP descriptors derived only from the canonical HTTP operation registry.',
 'fbp-node-catalog-json': 'Serialize the canonical HTTP-operation FBP projection as JSON.',
