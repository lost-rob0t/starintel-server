...
(defparameter +dataset-export-page-size+ 100)
(defparameter +dataset-export-consistency+ :monotonic-key-scan)

(defun dataset-export-end-key (dataset)
  (list dataset (jsown:empty-object)))

(defun dataset-export-temp-path (path)
  (pathname
