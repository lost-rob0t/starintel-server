...
;;;; StarIntel Gserver is an experimental processing framework for StarIntel
;;;; documents. Keep production exposure disabled until the stable branch gates
;;;; and deployment hardening are complete.
