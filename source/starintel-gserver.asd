(asdf:defsystem :starintel-gserver
  ...
  ((:file "document-access-package")
   ...
   (:file "http-contract-views-v2" :pathname "../cli/http-contract-views-v2")
   (:file "http-contract-activity-v2" :pathname "../cli/http-contract-activity-v2")
   (:file "package")
   (:file "leases/package")
   ...
   (:file "databases/view-registry-v2")
   (:file "databases/activity-v2")
   ...
   (:file "frontends/http-view-v2")
   (:file "frontends/http-activity-v2")
   (:file "frontends/http-status-message")
   (:file "frontends/http-capabilities")
   (:file "frontends/http-activity-v2-capabilities")
   (:file "frontends/http-auth")
   (:file "frontends/http-oauth-provider")
   (:file "frontends/http-authorization")
   (:file "frontends/http-view-v2-auth")
   (:file "frontends/http-activity-v2-auth")
