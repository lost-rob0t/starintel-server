(asdf:defsystem :starintel-gserver
  ...
  ((:file "ids")
   ...
   (:file "http-contract-storage" :pathname "../cli/http-contract-storage")
   (:file "package")
   ...
   (:file "actor-systems/document-storage-actor")
   (:file "actor-systems/document-storage-docs")
   ...
   (:file "frontends/http-document-lifecycle")
   (:file "frontends/http-storage-redaction")
   (:file "frontends/http-authorization-view-routes")
   (:file "frontends/http-contract-routes")
   (:file "frontends/http-storage-contract-routes")
