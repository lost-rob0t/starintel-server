(asdf:defsystem :starintel-gserver
  ...
  ((:file "ids")
   ...
   (:file "actor-systems/llm-actor-core")
   (:file "actor-systems/llm-actor-openrouter-policy")
   (:file "actor-systems/llm-actor-chat")
   (:file "actor-systems/llm-actor-validation")
   (:file "actor-systems/llm-actor-startup")
   ...
   (:file "frontends/http-llm-fine-tune")
   (:file "frontends/http-llm-chat")
