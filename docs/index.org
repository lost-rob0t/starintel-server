...
13. [[file:http-principal-capability-contract.org][HTTP principal and capability contract]] — principal classes, credentials, capabilities, scopes, decisions, and route mapping. Design contract.
...
| KV target leases | Design/stub | Authorization gates are active; no KV lease adapter exists and allowed lease operations return =501= |
